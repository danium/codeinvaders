...
Ownership: project maintainers and documentation contributors.
...
Runtime policy: documentation must describe an offline-capable local product;
the runtime must not depend on remote assets, analytics, or external services.
