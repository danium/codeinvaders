...
- [x] 2.8 Add protocol fixtures for valid events, invalid scopes, unknown optional fields, extensions, incompatible versions, duplicates, and correlation ambiguity.
- [x] 2.9 Publish protocol compatibility and extension documentation generated or checked against the executable schemas.
...
- [x] 13.10 Profile adapter full wall time, broker ingestion throughput and memory, reducer latency, spool fallback, journal rotation, replay seek time, 100 semantic entities, 300 pooled effects, and the sustained-load fixture.
